...
//将时间结构体转换为秒
uint32_t LPLD_DateTimeToTimeStamp(TimeStamp_FormatTypeDef *);
//将秒转换为时间结构体
uint8_t LPLD_TimeStampToDateTime(uint32_t , TimeStamp_FormatTypeDef *);
//获得周数结构体
uint8_t LPLD_GetWeek(TimeStamp_FormatTypeDef *);
