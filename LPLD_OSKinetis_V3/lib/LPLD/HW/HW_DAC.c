 ...
 *    1--配置成功
 */
uint8_t LPLD_DAC_Init(DAC_InitTypeDef dac_init_struct)
{
    uint8_t x;
 ...
 *    1--配置成功
 */
uint8_t LPLD_DAC_Deinit(DAC_InitTypeDef dac_init_struct)
{
    uint8_t x;
    DAC_Type *dacx = dac_init_struct.DAC_Dacx;
    //关闭DAC模块
 ...
 *    1--配置成功
 */
uint8_t LPLD_DAC_EnableIrq(DAC_InitTypeDef dac_init_struct)
{
    uint8_t x;
    DAC_Type *dacx = dac_init_struct.DAC_Dacx;
    if (dacx == DAC0) {
 ...
 *    1--配置成功
 */
uint8_t LPLD_DAC_DisableIrq(DAC_InitTypeDef dac_init_struct)
{
    uint8_t x;
    DAC_Type *dacx = dac_init_struct.DAC_Dacx;
    if (dacx == DAC0) {
 ...
 *    无
 */
void LPLD_DAC_SetBufferDataN(DAC_Type *dacx, uint16_t data, uint8_t num)
{
    //参数检查
 ...
 *    无
 */
void LPLD_DAC_SetBufferData(DAC_Type *dacx, uint16_t *data, uint8_t len)
{
    //参数检查
