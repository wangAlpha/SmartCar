...
//SPI初始化函数
uint8_t LPLD_SPI_Init(SPI_InitTypeDef);
//SPI反初始化函数
uint8_t LPLD_SPI_Deinit(SPI_InitTypeDef);
//SPI使能外设中断
uint8_t LPLD_SPI_EnableIrq(SPI_InitTypeDef);
//SPI禁止外设中断
uint8_t LPLD_SPI_DisableIrq(SPI_InitTypeDef);
//SPI主机读写函数
uint8_t LPLD_SPI_Master_WriteRead(SPI_Type *, uint8_t , uint8_t , uint8_t);
//SPI主机读函数
uint8_t LPLD_SPI_Master_Read(SPI_Type *);
//SPI主机写函数
void LPLD_SPI_Master_Write(SPI_Type *, uint8_t , uint8_t , uint8_t);
