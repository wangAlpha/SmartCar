...
#define CAN_MB_CS_CODE(x)           (((uint32_t)(((uint32_t)(x))<<CAN_MB_CS_CODE_SHIFT))&CAN_MB_CS_CODE_MASK)
#define CAN_MB_CS_RTR_MASK          (0x00100000u)
#define CAN_MB_CS_RTR_SHIFT         (20)
#define CAN_MB_CS_RTR(x)            (((uint32_t)(((uint32_t)(x))<<CAN_MB_CS_RTR_SHIFT))&CAN_MB_CS_RTR_MASK)
#define CAN_MB_CS_IDE_MASK          (0x00200000u)
#define CAN_MB_CS_IDE_SHIFT         (21)
#define CAN_MB_CS_IDE(x)            (((uint32_t)(((uint32_t)(x))<<CAN_MB_CS_IDE_SHIFT))&CAN_MB_CS_IDE_MASK)
#define CAN_MB_CS_SRR_MASK          (0x00400000u)
#define CAN_MB_CS_SRR_SHIFT         (22)
#define CAN_MB_CS_SRR(x)            (((uint32_t)(((uint32_t)(x))<<CAN_MB_CS_SRR_SHIFT))&CAN_MB_CS_SRR_MASK)
#define CAN_MB_CS_DLC_MASK          (0x000F0000u)
#define CAN_MB_CS_DLC_SHIFT         (16)
#define CAN_MB_CS_DLC(x)            (((uint32_t)(((uint32_t)(x))<<CAN_MB_CS_DLC_SHIFT))&CAN_MB_CS_DLC_MASK)
#define CAN_MB_CS_TIMESTAMP_MASK    (0x0000FFFFu)
#define CAN_MB_CS_TIMESTAMP_SHIFT   (0)
#define CAN_MB_CS_TIMESTAMP(x)      (((uint32_t)(((uint32_t)(x))<<CAN_MB_CS_TIMESTAMP_SHIFT))&CAN_MB_CS_TIMESTAMP_MASK)
...
#define CAN_MB_ID_PRIO(x)           (((uint32_t)(((uint32_t)(x))<<CAN_MB_ID_PRIO_SHIFT))&CAN_MB_ID_PRIO_MASK)
#define CAN_MB_ID_STD_MASK          (0x1FFC0000u)
#define CAN_MB_ID_STD_SHIFT         (18)
#define CAN_MB_ID_STD(x)            (((uint32_t)(((uint32_t)(x))<<CAN_MB_ID_STD_SHIFT))&CAN_MB_ID_STD_MASK)
#define CAN_MB_ID_EXT_MASK          (0x1FFFFFFFu)
#define CAN_MB_ID_EXT_SHIFT         (0)
#define CAN_MB_ID_EXT(x)            (((uint32_t)(((uint32_t)(x))<<CAN_MB_ID_EXT_SHIFT))&CAN_MB_ID_EXT_MASK)
...
//FlexCAN Msg缓冲区初始化
void LPLD_CAN_InitMessageObject(CAN_MSGOBJ_InitTypeDef , uint32_t);
//FlexCAN 传输Msg函数
uint8_t LPLD_CAN_TransmitMessage(CAN_MSGOBJ_InitTypeDef, CAN_MessageFormat_TypeDef *);
//FlexCAN 接收中断处理函数
