    ...
    */
    ...
    /*
      ...
      初始化：
        不必须初始化，默认0
    */
    uint8_t FB_WriteAddrHold;

} FB_InitTypeDef;

//FlexBux通用初始化函数
uint8_t LPLD_FlexBus_Init(FB_InitTypeDef);
