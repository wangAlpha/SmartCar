...
uint8_t LPLD_I2C_Init(I2C_InitTypeDef);
//I2Cx反初始化函数，关闭I2Cx中断，禁用I2Cx
uint8_t LPLD_I2C_Deinit(I2C_InitTypeDef);
//I2Cx中断使能函数
...
//I2Cx等待ACK信号函数
void LPLD_I2C_WaitAck(I2C_Type *, uint8_t);
//I2Cx再次产生开始信号函数
void LPLD_I2C_ReStart(I2C_Type *);
//I2Cx发送一个字节函数
void LPLD_I2C_WriteByte(I2C_Type *, uint8_t);
//I2Cx读取一个字节函数
uint8_t LPLD_I2C_ReadByte(I2C_Type *);
//I2Cx主机读写模式配置函数
void LPLD_I2C_SetMasterWR(I2C_Type *, uint8_t);
//I2C开始传输函数，需要设置外围设备地址和读写模式
void LPLD_I2C_StartTrans(I2C_Type *, uint8_t, uint8_t);
