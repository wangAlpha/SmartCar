...
*/
#define LCD_SCLK(x) LPLD_GPIO_Output_b(PTB, 11, x) //D0
#define LCD_SDA(x)  LPLD_GPIO_Output_b(PTB, 10, x) //D1
#define LCD_RST(x)  LPLD_GPIO_Output_b(PTB, 17, x) //复位低能电平
#define LCD_DC(x)   LPLD_GPIO_Output_b(PTB, 16, x) //偏置常低


//GPIO_InitStruct.GPIO_Pins = GPIO_Pin10|GPIO_Pin11|GPIO_Pin16|GPIO_Pin17;
...
//==============================================================
//函数名：LCD_Write_English_String(uint8_t x,uint8_t y,uint8_t *p)
//功能描述：写入一组标准ASCII字符串
