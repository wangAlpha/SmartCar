...
//初始化eDMA模块
uint8_t LPLD_DMA_Init(DMA_InitTypeDef);
//使能eDMA中断
uint8_t LPLD_DMA_EnableIrq(DMA_InitTypeDef);
//禁用eDMA中断
uint8_t LPLD_DMA_DisableIrq(DMA_InitTypeDef);
//DMA服务请求软件开始
