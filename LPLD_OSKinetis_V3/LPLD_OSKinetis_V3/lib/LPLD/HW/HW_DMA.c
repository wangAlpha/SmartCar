 ...
 *    1--配置成功
 */
uint8_t LPLD_DMA_Init(DMA_InitTypeDef dma_init_struct)
{
 ...
 *    1--成功
 */
uint8_t LPLD_DMA_EnableIrq(DMA_InitTypeDef dma_init_struct)
{
#if defined(CPU_MK60DZ10) || defined(CPU_MK60D10)
 ...
 *    1--成功
 */
uint8_t LPLD_DMA_DisableIrq(DMA_InitTypeDef dma_init_struct)
{
#if defined(CPU_MK60DZ10) || defined(CPU_MK60D10)
