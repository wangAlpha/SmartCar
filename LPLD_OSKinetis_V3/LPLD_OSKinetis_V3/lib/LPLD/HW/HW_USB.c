...
*        非0x00 发送失败
*/
uint8_t LPLD_USB_VirtualCom_Tx(uint8_t *tx_buf, uint8_t len)
{
    uint8_t status = 0;
...
*    无
*/
void LPLD_USB_HID_MouseControl(uint8_t *buf)
{
...
*    无
*/
void LPLD_USB_HID_LoopTask(uint8_t *buf)
{
