...
//UART获取一个字符
int8_t LPLD_UART_GetChar(UART_Type *);
//检查是否接收到字符
int32_t LPLD_UART_GetChar_Present(UART_Type *);
//UART发送一个字符
void LPLD_UART_PutChar(UART_Type *, uint8_t);
//UART发送字符数组
void LPLD_UART_PutCharArr(UART_Type *, uint8_t *, int32_t);
//UART中断使能
