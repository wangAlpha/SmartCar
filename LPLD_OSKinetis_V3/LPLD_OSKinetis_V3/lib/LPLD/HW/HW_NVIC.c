 ...
 *
*/
uint8_t LPLD_NVIC_Init(NVIC_InitTypeDef NVIC_InitStructure)
{
    uint8_t  request = 1;
    IRQn_Type int_id = NVIC_InitStructure.NVIC_IRQChannel;
    uint32_t nvic_priority_group = NVIC_InitStructure.NVIC_IRQChannelGroupPriority;
    uint32_t nvic_preemption_priority = NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority;
    uint32_t nvic_sub_priority = NVIC_InitStructure.NVIC_IRQChannelSubPriority;
